...
const sectionClassName = cn(
	// Bold section headers with bottom border
	"[&>h6]:text-lg",
	"[&>h6]:font-bold",
	"[&>h6]:pb-2",
	"[&>h6]:mb-4",
 ...
 * Template: Snorlax
 */
export function SnorlaxTemplate({ pageIndex, pageLayout }: TemplateProps) {
	const isFirstPage = pageIndex === 0;
	const { main, sidebar, fullWidth } = pageLayout;

	return (
		<div className="template-snorlax page-content space-y-(--page-gap-y) px-(--page-margin-x) pt-(--page-margin-y) print:p-0">
			{isFirstPage && <Header />}
...
function Header() {
	...
	return (
		<div className="page-header space-y-(--page-gap-y) border-(--page-primary-color) border-b-4 pb-(--page-gap-y)">
