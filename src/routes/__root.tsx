	...
	head: () => {
		...
		return {
			links: [
				...
				// Icons
				{ rel: "icon", href: "/logo/CVCraft_logo.png", type: "image/png", sizes: "any" },
				{ rel: "apple-touch-icon", href: "/logo/CVCraft_logo.png", type: "image/png", sizes: "180x180" },
				// Manifest
